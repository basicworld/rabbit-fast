...
import com.rabbit.framework.security.filter.JwtAuthenticationTokenFilter;
import com.rabbit.framework.security.handle.AuthenticationErrorEntryPointImpl;
import com.rabbit.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.antMatchers("/personal/login", "/captcha", "/personal/register").anonymous()
